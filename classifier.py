...
def score(y_true, y_pred):
    return classification_report(y_true, y_pred), classification_report(y_true, y_pred, output_dict=True)
...
report, report_dict = score(y_test, model.predict(tfidf.transform(X_test)))
print("report on test:", report)
print("saving classifier 'sentiment_classifier.lzma'")

#pickle.dump({'classifier':model, 'vectorizer':tfidf, 'report': report_dict}, lzma.open('sentiment_classifier.lzma','wb'))
